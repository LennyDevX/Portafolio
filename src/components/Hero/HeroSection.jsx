            ...
            {true && (
                ...
                >
                   <motion.h1 
                    ...
                    <Link to ="/hire">
                        <motion.button
                            className="hero-section-button mt-4 inline-block bg-transparent border border-blue-300 hover:border-green-400 text-white  py-3 px-3 rounded-lg transform transition-transform duration-300 hover:scale-110"
