...
const SecondHero = () => {
    ...
    return (
        <div className="hero-section flex flex-col md:flex-row-reverse items-center justify-center px-2 md:px-4 mt-2 md:mt-4">
            <div className="w-full md:w-1/2 ml-0 md:ml-2 mt-2 md:mt-4">
                <div className="w-2/4 md:w-full mx-auto md:max-w-sm items-center">
                    <img className="rounded-full" src={image.src} alt={image.alt} loading="lazy" width={image.width} height={image.height} />
                </div>
            </div>
            <div className="w-full md:w-1/2 text-center md:text-right mt-2 md:mt-4">
